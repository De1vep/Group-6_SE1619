                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="row modal-body">
                            ...
                            <form action="settingList?service=AddSetting" method="POST" >
                                    ...
                                    <div class="row">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" aria-label="Default select example" name="type" >
                                                ...
                                                <option value="4" >Test Type</option>
                                                <option value="5" >Quiz Level</option>
                                                <option value="6" >Lesson Type</option>
                                                <option value="7" >Dimension Type</option>
                                            </select>
                                        </div>
                                        ...
                                        <div class="d-block mx-4 mb-3 mb-lg-4 text-center">
                                            <button type="submit" class="btn btn-warning">Add Setting</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
